...
namespace Fortified;
public class CompProperties_FueledSpawner : CompProperties
{
    ...
    public class CompFueledSpawner : ThingComp
{
    ...
    public bool TryDoSpawn()
    {
        ...
        if (TryFindSpawnCell(parent, PropsSpawner.thingToSpawn, PropsSpawner.spawnCount, out var result))
        {
            ...
            if (thing == null) Log.Error("Could not spawn anything for " + parent);
    ...
    {
        if (PropsSpawner.writeTimeLeftToSpawn && PowerOn && HasFuel)
        {

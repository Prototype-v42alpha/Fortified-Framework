...
namespace Fortified
{
    public static class MechApparelGenerator
    {
        ...
        {
            // 支持 HumanlikeMech 和普通 Pawn
            if (!CanGenerateApparelFor(pawn))
            {
                return;
            }
        ...
        /// 支持 HumanlikeMech 和普通 Pawn
        /// </summary>
        private static bool CanGenerateApparelFor(Pawn pawn)
        {
            if (pawn == null)
            {
                return false;
